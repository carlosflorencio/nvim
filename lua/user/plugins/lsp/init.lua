return {
...

	{
		...
		dependencies = {
			-- needs to be disabled in order to user lspconfig.root_pattern
			-- https://github.com/LazyVim/LazyVim/discussions/409
			-- {
			-- 	"folke/neoconf.nvim",
			-- 	cmd = "Neoconf",
			-- 	config = true,
	...
	{ import = "user.plugins.lsp.individual.eslint" },
	{ import = "user.plugins.lsp.individual.json" },
	{ import = "user.plugins.lsp.individual.prettier" },
	{ import = "user.plugins.lsp.individual.typescript" },
	{ import = "user.plugins.lsp.individual.deno" },
}
